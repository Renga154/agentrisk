...
現時点の README は npm バッジではなく GitHub の `package.json` version badge を表示し、公開前でも動く `npm exec --yes github:Renga154/agentrisk -- ...` を主要導線にしています。npm 公開後は、npm badge と `npx agentrisk ...` の導線を前面に戻します。
